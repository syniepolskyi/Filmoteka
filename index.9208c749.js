 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Er{isEmpty(){return this.ns.isEmpty()}addReference(e,t){const n=new Sr(e,t);this.ns=this.ns.add(n),this.rs=this.rs.add(n)}us(e,t){e.forEach((e=>this.addReference(e,t)))}removeReference(e,t){this.cs(new Sr(e,t))}hs(e,t){e.forEach((e=>this.removeReference(e,t)))}ls(e){const t=new j(new B([])),n=new Sr(t,e),r=new Sr(t,e+1),i=[];return this.rs.forEachInRange([n,r],(e=>{this.cs(e),i.push(e.key)})),i}fs(){this.ns.forEach((e=>this.cs(e)))}cs(e){this.ns=this.ns.delete(e),this.rs=this.rs.delete(e)}ds(e){const t=new j(new B([])),n=new Sr(t,e),r=new Sr(t,e+1);let i=gn();return this.rs.forEachInRange([n,r],(e=>{i=i.add(e.key)})),i}containsKey(e){const t=new Sr(e,0),n=this.ns.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}constructor(){this.ns=new se(Sr.ss),this.rs=new se(Sr.os)}}class Sr{static ss(e,t){return j.comparator(e.key,t.key)||N(e._s,t._s)}static os(e,t){return N(e._s,t._s)||j.comparator(e.key,t.key)}constructor(e,t){this.key=e,this._s=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
(0,s("MjY8E").registerVersion)("firebase","9.9.4","app")})),s.register("3SEMc",(function(t,n){e(t.exports,"createUserWithEmailAndPassword",(function(){return s("lkOQh").a5})),e(t.exports,"getAuth",(function(){return s("lkOQh").n})),e(t.exports,"onAuthStateChanged",(function(){return s("lkOQh").v})),e(t.exports,"signInWithEmailAndPassword",(function(){return s("lkOQh").a6})),e(t.exports,"signOut",(function(){return s("lkOQh").y})),s("eMcUM")})),s.register("eMcUM",(function(t,n){e(t.exports,"createUserWithEmailAndPassword",(function(){return s("lkOQh").a5})),e(t.exports,"getAuth",(function(){return s("lkOQh").n})),e(t.exports,"onAuthStateChanged",(function(){return s("lkOQh").v})),e(t.exports,"signInWithEmailAndPassword",(function(){return s("lkOQh").a6})),e(t.exports,"signOut",(function(){return s("lkOQh").y})),s("2xDiJ"),s("MjY8E"),s("kZfxc"),s("6ExWU");s("lkOQh")})),s.register("lkOQh",(function(t,n){e(t.exports,"a5",(function(){return Ue})),e(t.exports,"a6",(function(){return Be})),e(t.exports,"v",(function(){return Fe})),e(t.exports,"y",(function(){return Ve})),e(t.exports,"n",(function(){return Zt}));var r=s("2xDiJ"),i=s("MjY8E"),o=s("4tSb9"),a=s("kZfxc"),l=s("6ExWU");function u(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const c=u,h=new(0,r.ErrorFactory)("auth","Firebase",{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}),d=new(0,a.Logger)("@firebase/auth");function p(e,...t){d.logLevel<=a.LogLevel.ERROR&&d.error(`Auth (${i.SDK_VERSION}): ${e}`,...t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
